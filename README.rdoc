This repository contains my solutions to the Ruby Koans. So please, browse
around and look at my answers. If you see anything that could be better, please
let me know.

I've also taken the liberty to fix some problems with the actual code that I
found along the way. I guess one can consider them as just another koan that
needs to be resolved.

*About the Extra Credit Project*:
I've completed the extra credit project which is to build the GREED game. I did
it in a TDD fashion, just after reading the 1st chapter of Ruby Best Practices,
so you'll see a lot of familiar code.
I have to admit that I don't really like how the interface worked out - mixing
the I/O with the game logic - but hey, it's working at the moment, so for now
it'll do. Maybe after reading the 2nd chapter (Beautiful APIs) I'll try refactor
the code into something more elegant.

If you want to play the game just run:
   [~] $ ruby koans/greed/bin/greed.rb
